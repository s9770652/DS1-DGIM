...
error_rate = st.slider(
    ...
    min_value=1, max_value=50, value=50, step=1, format='%f%%'
)
...
real_e, dgim_e = backend.real_count(edible, N), backend.dgim_count(edible, N, error_rate/100)
real_p, dgim_p = backend.real_count(poisonous, N), backend.dgim_count(poisonous, N, error_rate/100)
